...
func Precompiles() map[addr]ArbosPrecompile {
	...
	ArbGasInfo.methodsByName["GetL1DataThrottleInfo"].arbosVersion = 11
	...
	ArbOwner.methodsByName["SetL1DataThrottleSpeedLimit"].arbosVersion = 11
	ArbOwner.methodsByName["SetL1DataThrottleBacklog"].arbosVersion = 11
	ArbOwner.methodsByName["SetL1DataThrottleThreshold"].arbosVersion = 11
